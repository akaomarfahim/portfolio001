...
myLoadingDialog(BuildContext context) => showDialog(
    ...
    builder: (_) => Center(
            child: Container(
          width: Screen.isDesktop(context) ? MediaQuery.of(context).size.width * 0.04 : MediaQuery.of(context).size.width * 0.10,
          height: Screen.isDesktop(context) ? MediaQuery.of(context).size.width * 0.04 : MediaQuery.of(context).size.width * 0.10,
